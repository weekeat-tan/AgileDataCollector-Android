...
public class GetTravelInsurancePlanRecommendationRequest {
    private Integer id;
    ...
    public void setIns_comp(String ins_comp) {
        this.ins_comp = ins_comp;
    }
}
